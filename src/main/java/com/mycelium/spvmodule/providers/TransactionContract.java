...
public class TransactionContract {
    public static class TransactionSummary {
        ...
        public static final String SELECTION_HD_ACCOUNT = ACCOUNT_GUID + " = ? AND " + ACCOUNT_INDEX + " = ?";
        public static final String SELECTION_HD_ACCOUNT_SINCE = SELECTION_HD_ACCOUNT + " AND " + SINCE + " = ?";
